...
bool Solver::add_constraint(QPPP_MATRIX(double)& R, QPPP_MATRIX(double)& J, QPPP_VECTOR(double)& d, int& iq, double& R_norm)
{
    int n = d.size();
#ifdef QUADPROGPP_ENABLE_TRACING
...
void Solver::delete_constraint(QPPP_MATRIX(double)& R, QPPP_MATRIX(double)& J, QPPP_VECTOR(int)& A, QPPP_VECTOR(double)& u, int n, int p, int& iq, int l)
{
#ifdef QUADPROGPP_ENABLE_TRACING
